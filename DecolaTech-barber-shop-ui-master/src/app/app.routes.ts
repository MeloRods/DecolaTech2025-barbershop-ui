...
import { NewClientComponent } from './clients/components/new-client/new-client.component';
import { ListClientsComponent } from './clients/components/list-clients/list-clients.component';
import { SchedulesMonthComponent } from './schedules/components/schedules-month/schedules-month.component';
...
export const routes: Routes = [
    ...
    { path: 'schedule/month', component: SchedulesMonthComponent, data: { title: 'Agendamentos' } },
